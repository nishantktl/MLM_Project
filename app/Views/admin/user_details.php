...
<script>
    $(document).ready(function() { 
...

                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <button
                                type="button"
                                class="btn btn-sm btn-success login-user-btn"
        ...
        $('#usersTable').on('click', '.login-user-btn', function () {
            var userId = $(this).data('user-id');
            var username = $(this).data('username');

            if (!confirm('Login as ' + username + ' (' + userId + ')?')) {
                return;
            }

            $.ajax({
                url: "<?= site_url('admin/login_as_user') ?>",
                type: "POST",
                dataType: "json",
                data: {
                    user_id: userId,
